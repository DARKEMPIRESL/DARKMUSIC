...
1. Clone the repo
   ...
   ```sh
   git clone https://github.com/DARKEMPIRESL/DARKMUSIC
   ```
...
1. Search our repository for open or closed
   [Pull Requests](https://github.com/DARKEMPIRESL/DARKMUSIC/pulls)
...
6. [Open a Pull Request](https://github.com/DARKEMPIRESL/DARKMUSIC/compare?expand=1)
