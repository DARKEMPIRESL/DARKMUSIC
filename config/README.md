...
8. `STRING_SESSION` : Pyrogram Session Needed, Generate string from [@StringBot](http://t.me/Pyro_SessionGen_bot) in Telegram.
...
### How to get these? [Read from here](https://te.legra.ph/Spotify-04-06-3)
...
- If you plan to use DARK Music Bot with your own customized or modified code.
...
- You can change images which are used in DARK Music Bot.
...
1. `STRING_SESSION2` : Pyrogram Session Needed, Generate string from [@Session gen Bot](http://t.me/Pyro_SessionGen_bot) in Telegram.
2. `STRING_SESSION3` : Pyrogram Session Needed, Generate string from [@Session gen Bot](http://t.me/Pyro_SessionGen_bot) in Telegram.
3. `STRING_SESSION4` : Pyrogram Session Needed, Generate string from [@Session gen Bot](http://t.me/Pyro_SessionGen_bot) in Telegram.
4. `STRING_SESSION5` : Pyrogram Session Needed, Generate string from [@Session gen Bot](http://t.me/Pyro_SessionGen_bot) in Telegram.
